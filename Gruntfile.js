...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            lessComplier: {
                files: ['<%= config.public %>/styles/{,*/}*.less'],
        ...
        less: {
          development: {
            options: {
              paths: ["<%= config.pub %>/styles"]
            },
            files: {
              "<%= config.pub %>/styles/main.css": "<%= config.pub %>/styles/main.less"
            }
          }
        }
